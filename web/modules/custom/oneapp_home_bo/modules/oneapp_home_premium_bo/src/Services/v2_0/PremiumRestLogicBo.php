...
namespace Drupal\oneapp_home_premium_bo\Services\v2_0;

use Drupal\oneapp_home_premium\Services\v2_0\PremiumRestLogic;
...
class PremiumRestLogicBo extends PremiumRestLogic {
  ...
  public function get($account_id) {
    ...
    $configuration_service = \Drupal::config('oneapp_home.config');
